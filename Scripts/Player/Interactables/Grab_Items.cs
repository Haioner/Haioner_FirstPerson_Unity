...
public class Grab_Items : MonoBehaviour
{
	...
	*/
    ...
    private void Select(Rigidbody _Target, float _Distance)
	{
		...
		objDefaultProperties.objDrag = targetRB.drag;
		objDefaultProperties.objAngularDrag = targetRB.angularDrag;
		objDefaultProperties.objUseGravity = targetRB.useGravity;
		objDefaultProperties.objConstraints = targetRB.constraints;

		//Target Properties	
		targetRB.drag = objProperties.objDrag;
		targetRB.angularDrag = objProperties.objAngularDrag;
    ...
    private void Impulse()
    {
		...
		if (applyImpulse)
		{
			targetRB.velocity = objTransform.forward * impulseForce;
			Reset();
			grabbing = false;
			applyImpulse = false;
		}
    ...
    private void Reset()
	{
        ...
        targetRB.drag = objDefaultProperties.objDrag;
		targetRB.angularDrag = objDefaultProperties.objAngularDrag;
